            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                class="fa fa-arrow-left"></i></a> Ajouter Fournisseur</h2>
                    <ul class="breadcrumb">
                            ...
                            <div class="clearfix row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <select name="status" class="form-control show-tick">
                                        <option value="activer" {{old('activer')=='activer' ? 'selected' : '' }}>ACTIVER
                                        </option>
                                        <option value="desactiver" {{old('status')=='desactiver' ? 'selected' : '' }}>DESACTIVER
                                        </option>
                                    </select>
                                </div>
                            </div>
