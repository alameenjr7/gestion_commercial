            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    {{-- <span class="cart_counter float-right">
                        <button id="valider" class="mr-5 valider btn btn-info text-right" style="float: right; position: relative;">Facturer</button> 
                    </span> --}}
                    ...
                    <div class="row col-lg-12 col-md-12 col-sm-12">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select disabled name="client_id" id="client_id" class="form-control show-tick" required>
            ...
            <hr>
                <div class="row clearfix" id="ajout_fact">
                    ...
                    <div class="col-12" style="float: right; position: relative;">
                        <a id="add_to_facture" data-price="0" data-quantity="1" data-product-id=""
                            class="mr-5 disabled ml-2 btn btn-success float-right add_to_facture">
                            <i class="fa fa-cart-plus">  Enregistrer</i>
                        </a>
                        <a href="{{ route('facture.delete')}}"  id="_supprimer" class="ml-2 disabled btn btn-danger float-right"><i class="icon-trash">  Supprimer</i></a>
    ...
    <script>
        $("#product_id").change(function(){
            ...
            if(product_id != null){
                ...
                $.ajax({
                    url:"/admin/product/"+product_id+"/article",
                    type:"POST",
                    data:{
                        _token:"{{csrf_token()}}",
