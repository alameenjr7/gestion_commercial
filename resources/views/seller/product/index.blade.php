            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <h2>
                        ...
                        </a>Articles : <a class="btn btn-sm btn-outline-secondary" href="{{route('seller-product.create')}}">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$item->price}} <strong>F</strong></td>
                                            <td>{{$item->buying_price}} <strong>F</strong></td>
