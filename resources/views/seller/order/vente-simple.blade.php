            ...
            <hr>
                <div class="row clearfix" id="ajout_fact">
                    ...
                    <div class="col-12" style="float: right; position: relative;">
                        ...
                        <a href="{{ route('facture.delete')}}"  id="_supprimer" class="ml-2 disabled btn btn-danger float-right">
                            <i class="icon-trash">  Supprimer</i>
                        </a>
                        <a id="_nouveau" class="ml-2 disabled btn btn-info float-right _nouveau">
