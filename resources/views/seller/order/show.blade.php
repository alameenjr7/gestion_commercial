            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('seller') }}"><i class="icon-home"></i></a>
                            </li>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <div class="row">
                                                    <a href="{{ route('vendeur.order.facture',$order->id) }}"
                                                    ...
                                                    <a href="{{route('vendeur.order.pdf',$order->id)}}" title="Download facture"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-3" style="width: 150%; height:150%">
                                            ...
                                            <tbody>
                                                ...
                                                <form action="{{ route('vendeur.order.status') }}" method="post">
                                                    @csrf
