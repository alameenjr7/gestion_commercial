            ...
            <tbody>
                <tr>
                    <td class="esd-email-paddings" valign="top">
                        <table cellpadding="0" cellspacing="0" class="es-content esd-header-popover"text-align="center">
                            <tbody>
                                <tr>
                                    <td class="es-adaptive esd-stripe" esd-custom-block-id="1733"text-align="center">
                                        <table class="es-content-body" style="background-color: #efefef;" width="600"
                                            cellspacing="0" cellpadding="0" bgcolor="#ffffff"text-align="center">
                                            <tbody>
                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="es-infoblock esd-block-text es-m-txt-c"
                                                                                       text-align="left">
                                                                                        <p>Put your preheader text here
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                        ...
                        <table cellpadding="0" cellspacing="0" class="es-header"text-align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="1735"text-align="center">
                                        <table class="es-header-body" style="background-color: #fef5e4;" width="600"
                                            cellspacing="0" cellpadding="0" bgcolor="#fef5e4"text-align="center">
                                            <tbody>
                                                <tr>
                                                       ...
                                                       text-align="left">
                                                        ...
                                                        <table class="es-left" cellspacing="0" cellpadding="0"
                                                           text-align="left">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="es-m-p0r esd-container-frame" width="180"
                        ...
                        <table class="es-content" cellspacing="0" cellpadding="0"text-align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="1754"text-align="center">
                                        <table class="es-content-body" width="600" cellspacing="0" cellpadding="0"
                                            bgcolor="#ffffff"text-align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p10t es-p10b es-p20r es-p20l"
                                                        esd-general-paddings-checked="false"text-align="left">
                        ...
                        <table class="es-content" cellspacing="0" cellpadding="0" text-align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="1755" text-align="center">
                                        <table class="es-content-body" width="600" cellspacing="0" cellpadding="0"
                                            bgcolor="#ffffff" text-align="center">
                                            <tbody>
                                                <tr>
                                                                                        ...
                                                                                        <table style="width: 100%;"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">#{{$details['order_number']}}</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td><span
                                                                                                    ...
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">{{\Carbon\Carbon::parse($details['created_at'])->format('
                                                                                                            d M
                                                                                                            y')}}</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">{{Helper::currency_converter($details['total_amount'])}}</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20b es-p20r es-p20l"
                                                                                        text-align="left">
                                                                                        <p>{{$details['n_first_name']}}
                                                                                            {{$details['n_last_name']}}
                                                                                        </p>
                                                                                        <p>{{$details['n_city']}}</p>
                                                                                        <p>{{$details['n_address']}}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                        ...
                        <table class="es-content" cellspacing="0" cellpadding="0" text-align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="1758" text-align="center">
                                        <table class="es-content-body" width="600" cellspacing="0" cellpadding="0"
                                            bgcolor="#ffffff" text-align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p10t es-p10b es-p20r es-p20l"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="es-m-p0r es-m-p20b esd-container-frame"
                                                                        width="270" valign="top" text-align="center">
                                                                        <table width="100%" cellspacing="0"
                                                                            cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                        ...
                                                        <!--[if mso]></td><td width="20"></td><td width="270" valign="top"><![endif]-->
                                                        <table cellspacing="0" cellpadding="0" text-align="right">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="270"
                                                                        text-align="left">
                                                        ...
                                                        <table class="es-left" cellspacing="0" cellpadding="0"
                                                           text-align="left">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="es-m-p0r es-m-p20b esd-container-frame"
                                                                        width="178" valign="top"text-align="center">
                                                                        <table width="100%" cellspacing="0"
                                                                            cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" class="es-footer"text-align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="1748"text-align="center">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p5t es-m-txt-c"
                                                                                       text-align="left">
                                                                                        <p><a target="_blank"
                                                                                                href="tel:123456789">123456789</a><br><a
                                                                                                target="_blank"
                                                                                                href="mailto:your@mail.com">your@mail.com</a>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c"
                                                                                       text-align="left">
                                                                                        <p>Vector graphics designed by
                                                                                            <a target="_blank"
                                                                                                href="http://www.freepik.com/">Freepik</a>.<br>
                                                                                        </p>
                                                                                        <p>You are receiving this email
                                                                                            because you have visited our
                                                                                            site or asked us about
                                                                                            regular newsletter<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td text-align="left"
                        ...
                        <table class="esd-footer-popover es-content" cellspacing="0" cellpadding="0"text-align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe"text-align="center">
                                        <table class="es-content-body" style="background-color: transparent;"
                                            width="600" cellspacing="0" cellpadding="0"text-align="center">
                                            <tbody>
                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-image es-infoblock made_with"
                                                                                       text-align="center"
                                                                                        style="font-size:0"><a
                                                                                            target="_blank"
                                                                                            href="https://viewstripo.email/?utm_source=templates&utm_medium=email&utm_campaign=pets&utm_content=trigger_newsletter"><img
