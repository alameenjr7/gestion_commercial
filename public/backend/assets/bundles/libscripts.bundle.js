!(function(e, t) {
  ...
  (C.fn = C.prototype = {
    ...
    for (
      "boolean" == typeof s &&
        ((u = s), (s = arguments[a] || {}), a++), "object" == typeof s ||
        y(s) ||
        (s = {}), a === l && ((s = this), a--);
      a < l;
      a++
    ...
    guid: 1,
    support: v
  }), "function" == typeof Symbol && (C.fn[Symbol.iterator] = t[Symbol.iterator]), C.each(
  ...
  var h = (function(n) {
    ...
    try {
      O.apply((t = j.call(y.childNodes)), y.childNodes), t[y.childNodes.length]
        .nodeType;
    } catch (n) {
      O = {
        apply: t.length
        ...
        if (h.qsa && !S[e + " "] && (!m || !m.test(e))) {
          if (1 !== d) (f = t), (c = e);
            ...
            for (
              (a = t.getAttribute("id"))
                ? (a = a.replace(te, ne))
                : t.setAttribute("id", (a = C)), o = (u = p(e)).length;
              o--;
    ...
    function se() {
      ...
      return function e(t, n) {
        return i.push(t + " ") > b.cacheLength && delete e[i.shift()], (e[
          t + " "
        ] = n);
      };
    }
          ...
          (
            ...
            (h.getById = le(function(e) {
              return (s.appendChild(
                e
              ).id = C), !T.getElementsByName || !T.getElementsByName(C).length;
            })),
            h.getById
              ? (
            ...
            (b.find.TAG = h.getElementsByTagName
              ? function(e, t) {
                  return void 0 !== t.getElementsByTagName
                    ...
                    : h.qsa ? t.querySelectorAll(e) : void 0;
                }
              : function(e, t) {
                  var n,
                    i = [],
              ...
              (
                le(function(e) {
                  (s.appendChild(e).innerHTML =
                    ...
                    "'></a><select id='" +
                    C +
                    "-\r\\' msallowcapture=''><option selected=''></option></select>"), e.querySelectorAll("[msallowcapture^='']").length && m.push("[*^$]=" + H + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || m.push("\\[" + H + "*(?:value|" + P + ")"), e.querySelectorAll("[id~=" + C + "-]").length || m.push("~="), e.querySelectorAll(":checked").length || m.push(":checked"), e.querySelectorAll("a#" + C + "+*").length || m.push(".#.+[+~]");
                }),
                le(function(e) {
                  e.innerHTML =
                  ...
                  t.setAttribute(
                    "type",
                    "hidden"
                  ), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && m.push("name" + H + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && m.push(":enabled", ":disabled"), (s.appendChild(e).disabled = !0), 2 !== e.querySelectorAll(":disabled").length && m.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), m.push(",.*:");
                })
              ),
            (h.matchesSelector = X.test(
              ...
              le(function(e) {
                (h.disconnectedMatch = c.call(
                  e,
                  "*"
                )), c.call(e, "[s!='']:x"), a.push("!=", W);
              }),
        ...
        pseudos: {
          ...
          lang: ae(function(n) {
            return Q.test(n || "") ||
              oe.error(
                "unsupported lang: " + n
              ), (n = n.replace(Z, ee).toLowerCase()), function(e) {
              var t;
              do {
                if (
                  (t = x
    ...
    function we(h, p, g, m, v, e) {
      return m && !m[C] && (m = we(m)), v &&
        !v[C] &&
        (v = we(v, e)), ae(function(e, t, n, i) {
        var r,
          o,
          s,
          a = [],
    ...
    return (me.prototype = b.filters =
      b.pseudos), (b.setFilters = new me()), (p = oe.tokenize = function(e, t) {
      var n,
        i,
        r,
        o,
      ...
      C.split("").sort(A).join("") ===
      C), (h.detectDuplicates = !!u), E(), (h.sortDetached = le(function(e) {
  ...
  (C.filter = function(e, t, n) {
    ...
    is: function(e) {
      return !!N(this, "string" == typeof e && D.test(e) ? C(e) : e || [], !1)
        .length;
    }
  });
  var k,
    ...
    function(i, r) {
      C.fn[i] = function(e, t) {
        ...
        return "Until" !== i.slice(-5) && (t = e), t &&
          "string" == typeof t &&
          (n = C.filter(t, n)), 1 < this.length &&
          (j[i] || C.uniqueSort(n), O.test(i) && n.reverse()), this.pushStack(
          n
        );
      };
    }
        ...
        s = {
          ...
          then: function(t, n, i) {
                    ...
                    : function() {
                        try {
                          ...
                          C.Deferred.exceptionHook &&
                            C.Deferred.exceptionHook(e, t.stackTrace), l <=
                            r + 1 &&
                            (
                              s !== R && ((n = void 0), (i = [e])),
                              o.rejectWith(n, i)
            ...
            return C.Deferred(function(e) {
              ...
              ), o[1][3].add(u(0, e, y(t) ? t : H)), o[2][3].add(u(0, e, y(n) ? n : R));
            }).promise();
          },
          promise: function(e) {
    ...
    when: function(e) {
      var n = arguments.length,
        ...
        s = function(t) {
          return function(e) {
            (i[t] = this), (r[t] =
              1 < arguments.length ? a.call(arguments) : e), --n ||
              o.resolveWith(i, r);
          };
        };
      if (
  ...
  function F() {
    x.removeEventListener(
      "DOMContentLoaded",
      F
    ), T.removeEventListener("load", F), C.ready();
  }
  ...
  C.extend({
    ...
    data: function(n, e) {
      ...
      if (
        this.length &&
        ((r = X.get(o)), 1 === o.nodeType && !z.get(o, "hasDataAttrs"))
      ) {
        for (t = s.length; t--; )
          s[t] &&
    ...
    queue: function(e, t, n) {
      var i;
      if (e)
        return (t = (t || "fx") + "queue"), (i = z.get(e, t)), n &&
          (!i || Array.isArray(n)
  ...
  function oe(e, t, n, i) {
    ...
    if (c && c[3] !== u) {
      for (l /= 2, u = u || c[3], c = +l || 1; s--; )
        C.style(e, t, c + u), (1 - o) * (1 - (o = a() / l || 0.5)) <= 0 &&
          (s = 0), (c /= o);
    ...
    for (
      ...
      if ((o = e[h]) || 0 === o)
        if ("object" === w(o)) C.merge(d, o.nodeType ? [o] : o);
          ...
          for (
            s = s || f.appendChild(t.createElement("div")), a = (ue.exec(o) || [
              "",
              ""
            ])[1]
              .toLowerCase(), l = fe[a] || fe._default, s.innerHTML =
              l[1] + C.htmlPrefilter(o) + l[2], c = l[0];
            c--;
  ...
  (pe = x
    ...
    .appendChild(
      x.createElement("div")
    )), (ge = x.createElement("input")).setAttribute("type", "radio"), ge.setAttribute("checked", "checked"), ge.setAttribute("name", "t"), pe.appendChild(ge), (v.checkClone = pe.cloneNode(!0).cloneNode(!0).lastChild.checked), (pe.innerHTML = "<textarea>x</textarea>"), (v.noCloneChecked = !!pe.cloneNode(!0).lastChild.defaultValue);
  ...
  (C.event = {
    ...
    add: function(t, e, n, i, r) {
      ...
      if (m)
        for (
          n.handler && ((n = (o = n).handler), (r = o.selector)), r &&
            C.find.matchesSelector(ye, r), n.guid || (n.guid = C.guid++), (l =
            m.events) || (l = m.events = {}), (s = m.handle) ||
          ...
          for (
            ...
            (a.rnamespace && !a.rnamespace.test(o.namespace)) ||
              (
                ...
                (a.data = o.data),
                void 0 !==
                  (i = ((C.event.special[o.origType] || {}).handle || o.handler)
                    .apply(r.elem, l)) &&
                  !1 === (a.result = i) &&
          ...
          if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
            for (o = [], s = {}, n = 0; n < l; n++)
              void 0 === s[(r = (i = t[n]).selector + " ")] &&
                (s[r] = i.needsContext
                  ? -1 < C(r, this).index(u)
                  : C.find(r, this, null, [u]).length), s[r] && o.push(i);
            o.length && a.push({ elem: u, handlers: o });
          }
      return (u = this), l < t.length &&
        a.push({ elem: u, handlers: t.slice(l) }), a;
    },
      ...
      C.event.special[e] = {
        ...
        handle: function(e) {
          var t,
            n = e.relatedTarget,
            i = e.handleObj;
          return (n && (n === this || C.contains(this, n))) ||
            (
              (e.type = i.origType),
    ...
    off: function(e, t, n) {
      ...
      if (e && e.preventDefault && e.handleObj)
        return (i = e.handleObj), C(e.delegateTarget).off(
  ...
  function Le(n, i, r, o) {
    ...
    if (
      ...
      for (a = (s = C.map(de(e, "script"), Ie)).length; c < f; c++)
        (l = e), c !== d &&
          ((l = C.clone(l, !0, !0)), a && C.merge(s, de(l, "script"))), r.call(
          n[c],
          l,
          c
        );
  ...
  function Pe(e, t, n) {
    for (var i, r = t ? C.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
      n || 1 !== i.nodeType || C.cleanData(de(i)), i.parentNode &&
        (
    ...
    clone: function(e, t, n) {
      ...
      if (
        ...
        for (s = de(c), i = 0, r = (o = de(e)).length; i < r; i++)
          (a = o[i]), (l = s[i]), void 0, "input" ===
            (u = l.nodeName.toLowerCase()) && le.test(a.type)
            ? (l.checked = a.checked)
            : ("input" !== u && "textarea" !== u) ||
      ...
      return 0 < (s = de(c, "script")).length &&
        he(s, !f && de(e, "script")), c;
    },
    ...
    function(e, s) {
      C.fn[e] = function(e) {
        for (var t, n = [], i = C(e), r = i.length - 1, o = 0; o <= r; o++)
          (t = o === r ? this : this.clone(!0)), C(i[o])[s](t), l.apply(
            n,
            t.get()
          );
    ...
    function e() {
      if (l) {
        (a.style.cssText =
          ...
          "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%"), ye
          .appendChild(a)
          .appendChild(l);
        var e = T.getComputedStyle(l);
        (n = "1%" !== e.top), (s = 12 === t(e.marginLeft)), (l.style.right =
          "60%"), (o = 36 === t(e.right)), (i =
          36 === t(e.width)), (l.style.position = "absolute"), (r =
          36 === l.offsetWidth || "absolute"), ye.removeChild(a), (l = null);
      }
    }
    function t(e) {
  ...
  function ze(e, t, n, i, r, o) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += C.css(e, n + ne[s], !0, r)), i
        ? (
            "content" === n && (l -= C.css(e, "padding" + ne[s], !0, r)),
            "margin" !== n && (l -= C.css(e, "border" + ne[s] + "Width", !0, r))
          )
        : (
    ...
    return (s =
      ...
      (v.boxSizingReliable() ||
        r ===
          e.style[
            t
          ])), ("auto" === r || (!parseFloat(r) && "inline" === C.css(e, "display", !1, i))) && ((r = e["offset" + t[0].toUpperCase() + t.slice(1)]), (s = !0)), (r = parseFloat(r) || 0) + ze(e, t, n || (o ? "border" : "content"), s, i, r) + "px";
  }
  ...
  C.extend({
    ...
    css: function(e, t, n, i) {
      var r,
        ...
        s,
        a = Q(t);
      return Be.test(t) || (t = Ve(a)), (s = C.cssHooks[t] || C.cssHooks[a]) &&
        "get" in s &&
    ...
    C.cssHooks[a] = {
      ...
      set: function(e, t, n) {
        ...
        return o &&
          ...
          (i = te.exec(t)) &&
          "px" !== (i[3] || "px") &&
          ((e.style[a] = t), (t = C.css(e, a))), Ye(0, t, s);
      }
    };
    ...
    run: function(e) {
      ...
      return this.options.duration
        ...
        ? n.set(this)
        : Ge.propHooks._default.set(this), this;
    }
  }).init.prototype =
    Ge.prototype), ((Ge.propHooks = {
    _default: {
      get: function(e) {
        var t;
        ...
        (null != e.elem[e.prop] && null == e.elem.style[e.prop])
          ? e.elem[e.prop]
          : (t = C.css(e.elem, e.prop, "")) && "auto" !== t ? t : 0;
      },
      set: function(e) {
        C.fx.step[e.prop]
          ? C.fx.step[e.prop](e)
  ...
  function lt(o, e, t) {
    var n,
      ...
      l = function() {
        ...
        for (
          ...
          u.tweens[i].run(n);
        return a.notifyWith(o, [u, n, t]), n < 1 && r
          ? t
    ...
    for (
      ...
      if ((n = lt.prefilters[i].call(u, o, c, u.opts)))
        return y(n.stop) &&
          (C._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)), n;
    return C.map(
      c,
      at,
      u
    ), y(u.opts.start) && u.opts.start.call(o, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), C.fx.timer(C.extend(l, { elem: o, anim: u, queue: u.opts.queue })), u;
  }
  (C.Animation = C.extend(lt, {
    ...
    tweener: function(e, t) {
      for (
        ...
        (n = e[i]), (lt.tweeners[n] = lt.tweeners[n] || []), lt.tweeners[
          n
        ].unshift(t);
    },
    prefilters: [
          ...
          for (i in (
            ...
            l ||
              (
                ...
                g && ae([e], !0),
                d.done(function() {
                  for (i in (g || ae([e]), z.remove(e, "fxshow"), h))
                    C.style(e, i, h[i]);
                })
              ), (l = at(g ? m[i] : 0, i, d)), i in m ||
    ...
    stop: function(r, e, o) {
      ...
      return "string" != typeof r && ((o = e), (e = r), (r = void 0)), e &&
        !1 !== r &&
    ...
    finish: function(s) {
      return !1 !== s && (s = s || "fx"), this.each(function() {
        var e,
          ...
          o = n ? n.length : 0;
        for (
          t.finish = !0, C.queue(this, s, []), i &&
            i.stop &&
            i.stop.call(this, !0), e = r.length;
          e--;
    ...
    return (i = (C.fx && C.fx.speeds[i]) || i), (e =
    ...
    "input"
  )), (tt = x.createElement("select").appendChild(x.createElement("option"))), (et.type = "checkbox"), (v.checkOn = "" !== et.value), (v.optSelected = tt.selected), ((et = x.createElement("input")).value = "t"), (et.type = "radio"), (v.radioValue = "t" === et.value);
  var ut,
          ...
          : (
              ...
              void 0 !== n
                ...
                : r && "get" in r && null !== (i = r.get(e, t))
                  ? i
                  : null == (i = C.find.attr(e, t)) ? void 0 : i
            );
    },
    attrHooks: {
      type: {
  ...
  C.fn.extend({
    ...
    prop: function(e, t, n) {
      var i,
        ...
        o = e.nodeType;
      if (3 !== o && 8 !== o && 2 !== o)
        return (1 === o && C.isXMLDoc(e)) ||
          ((t = C.propFix[t] || t), (r = C.propHooks[t])), void 0 !== n
          ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e[t] = n)
          : r && "get" in r && null !== (i = r.get(e, t)) ? i : e[t];
    },
    propHooks: {
      tabIndex: {
        get: function(e) {
          ...
          return t
            ? parseInt(t, 10)
            : ft.test(e.nodeName) || (dt.test(e.nodeName) && e.href) ? 0 : -1;
        }
      }
    },
    ...
    toggleClass: function(r, t) {
      ...
      return "boolean" == typeof t && s
        ? t ? this.addClass(r) : this.removeClass(r)
        : y(r)
          ...
          : this.each(function() {
              ...
              if (s)
                ...
                (void 0 !== r && "boolean" !== o) ||
                  (
                    (e = pt(this)) && z.set(this, "__className__", e),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
  ...
  C.extend(C.event, {
    trigger: function(e, t, n, i) {
      ...
      if (
        ...
        if (!i && !c.noBubble && !_(n)) {
          for (
            a = c.delegateType || h, vt.test(a + h) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            d.push(o), (s = o);
        ...
        for (r = 0; (o = d[r++]) && !e.isPropagationStopped(); )
          (f = o), (e.type = 1 < r ? a : c.bindType || h), (u =
            (z.get(o, "events") || {})[e.type] && z.get(o, "handle")) &&
            u.apply(o, t), (u = l && o[l]) &&
            u.apply &&
            V(o) &&
  ...
  (Ht.href = _t.href), C.extend({
    ...
    ajax: function(e, t) {
      ...
      if (
        ...
        i = x.createElement("a");
        try {
          (i.href = m.url), (i.href = i.href), (m.crossDomain =
    ...
    C[r] = function(e, t, n, i) {
      return y(t) && ((i = i || n), (n = t), (t = void 0)), C.ajax(
        C.extend(
  ...
  (v.cors =
    !!Ft &&
    "withCredentials" in Ft), (v.ajax = Ft = !!Ft), C.ajaxTransport(function(
    r
  ) {
    var o, s;
    if (v.cors || (Ft && !r.crossDomain))
      return {
        send: function(e, t) {
          ...
          for (n in (
            r.mimeType && i.overrideMimeType && i.overrideMimeType(r.mimeType),
            r.crossDomain ||
              e["X-Requested-With"] ||
          ...
          }), (i.onload = o()), (s = i.onerror = i.ontimeout = o(
            "error"
          )), void 0 !== i.onabort
            ? (i.onabort = s)
    ...
    if (n.crossDomain)
      return {
        send: function(e, t) {
          (i = C("<script>").prop({ charset: n.scriptCharset, src: n.url }).on(
            "load error",
            (r = function(e) {
              i.remove(), (r = null), e &&
  ...
  C.ajaxSetup({
    ...
    if (s || "jsonp" === e.dataTypes[0])
      return (i = e.jsonpCallback = y(e.jsonpCallback)
        ...
        : !1 !== e.jsonp &&
          (e.url +=
            (wt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), (e.converters[
        "script json"
      ] = function() {
        ...
        void 0 === r
          ...
          : (T[
              i
            ] = r), e[i] && ((e.jsonpCallback = t.jsonpCallback), Ut.push(i)), o && y(r) && r(o[0]), (o = r = void 0);
      }), "script";
    ...
    var i,
      ...
      s = this,
      a = e.indexOf(" ");
    return -1 < a && ((i = ht(e.slice(a))), (e = e.slice(0, a))), y(t)
      ? ((n = t), (t = void 0))
    ...
    setOffset: function(e, t, n) {
      var i,
        ...
        f = {};
      "static" === u &&
        (e.style.position = "relative"), (a = c.offset()), (o = C.css(
        e,
        "top"
      )), (l = C.css(e, "left")), (r =
        ("absolute" === u || "fixed" === u) && -1 < (o + l).indexOf("auto")
          ? ((s = (i = c.position()).top), i.left)
          : ((s = parseFloat(o) || 0), parseFloat(l) || 0)), y(t) &&
        (t = t.call(e, n, C.extend({}, a))), null != t.top &&
        (f.top = t.top - a.top + s), null != t.left &&
        (f.left = t.left - a.left + r), "using" in t
        ? t.using.call(e, f)
        : c.css(f);
    }
  }), C.fn.extend({
    ...
    position: function() {
      if (this[0]) {
        ...
        if ("fixed" === C.css(i, "position")) t = i.getBoundingClientRect();
          ...
          for (
            t = this.offset(), n = i.ownerDocument, e =
          ...
          function(e, t, n) {
            ...
            return _(e)
              ...
              : 9 === e.nodeType
                ...
                : void 0 === n ? C.css(e, t, r) : C.style(e, t, n, r);
          },
          a,
          n ? e : void 0,
          n
  ...
  }), (C.isArray = Array.isArray), (C.parseJSON = JSON.parse), (C.nodeName = S), (C.isFunction = y), (C.isWindow = _), (C.camelCase = Q), (C.type = w), (C.now = Date.now), (C.isNumeric = function(
    e
  ) {
    var t = C.type(e);
  ...
  function S(e, t) {
    ...
    if (((c.marginTop = 0), (c.marginLeft = 0), !n && i)) {
      ...
      (c.top -= l - f), (c.bottom -= l - f), (c.left -= u - d), (c.right -=
        u - d), (c.marginTop = f), (c.marginLeft = d);
    }
    return (n ? t.contains(s) : t === s && "BODY" !== s.nodeName) &&
      (c = (function(e, t) {
        var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
          i = T(t, "top"),
          r = T(t, "left"),
          o = n ? -1 : 1;
        return (e.top += i * o), (e.bottom += i * o), (e.left +=
          r * o), (e.right += r * o), e;
      })(c, t)), c;
  }
  function d(e, t, n, i) {
    var r,
      ...
      d = E(e, t);
    if ("viewport" === i)
      (o = (r = d).ownerDocument.documentElement), (s = S(r, o)), (a = R(
        o.clientWidth,
        window.innerWidth || 0
      )), (l = R(o.clientHeight, window.innerHeight || 0)), (u = T(o)), (c = T(
        o,
        "left"
      )), (f = C({
      ...
      if (
        ...
        (f.top += p.top - p.marginTop), (f.bottom = m + p.top), (f.left +=
          p.left - p.marginLeft), (f.right = v + p.left);
      }
    }
  ...
  function k(e, t, n) {
    ...
    var i = A(e),
      ...
      u = o ? "width" : "height";
    return (r[s] =
      t[s] + t[l] / 2 - i[l] / 2), (r[a] = n === a ? t[a] - i[u] : t[N(a)]), r;
  }
  function I(e, t) {
  ...
  var W,
    ...
    F = function() {
      return null == W &&
        (W = -1 !== navigator.appVersion.indexOf("MSIE 10")), W;
    },
    B = (function() {
      function i(e, t) {
    ...
    X = (function() {
      function o(e, t) {
        ...
        (function(e, t) {
        ...
        }), (this.update = M(this.update.bind(this))), (this.options = K(
          {},
          o.Defaults,
          i
        )), (this.state = {
          ...
          t && t.jquery ? t[0] : t), (this.options.modifiers = {}), Object.keys(
      ...
      return B(o, [
          ...
          value: function() {
            return function() {
              if (!this.state.isDestroyed) {
                ...
                )), (e.originalPlacement = e.placement), (e.offsets.popper = k(
                  this.popper,
                  e.offsets.reference,
                  e.placement
                )), (e.offsets.popper.position = "absolute"), (e = O(
                  this.modifiers,
                  e
        ...
        },
        {
          ...
          value: function() {
            return function() {
              return (this.state.isDestroyed = !0), e(
                this.modifiers,
                "applyStyle"
              ) &&
                (
  ...
  return (X.Utils = ("undefined" == typeof window
    ? global
    : window).PopperUtils), (X.placements = $), (X.Defaults = {
    placement: "bottom",
    eventsEnabled: !0,
    removeOnDestroy: !1,
    onCreate: function() {},
    ...
    modifiers: {
      ...
      offset: {
        ...
        fn: function(e, t) {
          var n,
            ...
            a = o.reference,
            l = r.split("-")[0];
          return (n = h(+i) ? [+i, 0] : p(i, s, a, l)), "left" === l
            ...
            : "right" === l
              ...
              : "top" === l
                ...
                : "bottom" === l &&
                  ((s.left += n[0]), (s.top += n[1])), (e.popper = s), e;
        },
        offset: 0
      },
      preventOverflow: {
          ...
          var n = i.priority,
            ...
            s = {
              ...
              secondary: function(e) {
                ...
                return o[e] > r[e] &&
                  !i.escapeWithReference &&
                  (n = P(o[t], r[e] - ("right" === e ? o.width : o.height))), U(
                  {},
                  t,
                  n
                );
      ...
      keepTogether: {
        ...
        fn: function(e) {
          var t = e.offsets,
            ...
            l = s ? "left" : "top",
            u = s ? "width" : "height";
          return n[a] < o(i[l]) && (e.offsets.popper[l] = o(i[l]) - n[u]), n[
            l
          ] > o(i[a]) && (e.offsets.popper[l] = o(i[a])), e;
        }
      },
      arrow: {
        order: 500,
        ...
        fn: function(e, t) {
          ...
          var r = e.placement.split("-")[0],
            ...
            h = l ? "bottom" : "right",
            p = A(i)[u];
          a[h] - p < s[f] && (e.offsets.popper[f] -= s[f] - (a[h] - p)), a[f] +
            p >
            s[h] &&
            (e.offsets.popper[f] += a[f] + p - s[h]), (e.offsets.popper = C(
            e.offsets.popper
          ));
          var g = a[f] + a[u] / 2 - p / 2,
          ...
          return b.forEach(function(e, t) {
            ...
            (s || f || h) &&
              (
                ...
                (s || f) && (v = b[t + 1]),
                h &&
                  (_ = "end" === (n = _) ? "start" : "start" === n ? "end" : n),
                (p.placement = v + (_ ? "-" + _ : "")),
                (p.offsets.popper = K(
                  {},
                  p.offsets.popper,
                  k(p.instance.popper, p.offsets.reference, p.placement)
                )),
      ...
      inner: {
        ...
        fn: function(e) {
          ...
          return (r[s ? "left" : "top"] =
            o[n] - (a ? r[s ? "width" : "height"] : 0)), (e.placement = N(
            t
          )), (e.offsets.popper = C(r)), e;
        }
      },
      hide: {
        order: 800,
      ...
      computeStyle: {
        ...
        fn: function(e, t) {
          ...
          if (
            ...
            (c[p] = "translate3d(" + s + "px, " + a + "px, 0)"), (c[d] = 0), (c[
              h
          ...
          return (e.attributes = K({}, v, e.attributes)), (e.styles = K(
            {},
            c,
            e.styles
      ...
      applyStyle: {
        ...
        enabled: !0,
        fn: function(e) {
          return u(e.instance.popper, e.styles), (t = e.instance.popper), (n =
            e.attributes), Object.keys(n).forEach(function(e) {
            !1 === n[e] ? t.removeAttribute(e) : t.setAttribute(e, n[e]);
          }), e.arrowElement &&
            Object.keys(e.arrowStyles).length &&
            u(e.arrowElement, e.arrowStyles), e;
          var t, n;
        },
  ...
  (t =
    t && t.hasOwnProperty("default")
      ? t.default
      : t), (c = c && c.hasOwnProperty("default") ? c.default : c);
  var r,
    n,
    o,
    a,
    ...
    Bn = (function(i) {
      ...
      return (i.fn.emulateTransitionEnd = e), (i.event.special[
        l.TRANSITION_END
      ] = {
        bindType: t,
        delegateType: t,
    ...
    Un = (
      ...
      (g = (function() {
        ...
        return (e.close = function(e) {
          var t = this._element;
          e && (t = this._getRootElement(e)), this._triggerCloseEvent(
            t
    ...
    Kn = (
      ...
      (I = (function() {
        ...
        return (e.toggle = function() {
            ...
            if (i) {
              ...
              if (e) {
                if (
                  ...
                  return;
                (i.checked = !m(this._element).hasClass(E)), m(i).trigger(
                  "change"
                );
              }
              i.focus(), (t = !1);
          ...
          return this.each(function() {
            var e = m(this).data(y);
            e ||
              ((e = new n(this)), m(this).data(y, e)), "toggle" === t && e[t]();
          });
        }), s(n, null, [
          {
            key: "VERSION",
      ...
      m(document)
        .on(k.CLICK_DATA_API, C, function(e) {
          ...
          var t = e.target;
          m(t).hasClass(T) ||
            (t = m(t).closest(N)), I._jQueryInterface.call(m(t), "toggle");
        })
      ...
      (oe = (function() {
        function o(e, t) {
          (this._items = null), (this._interval = null), (this._activeElement = null), (this._isPaused = !1), (this._isSliding = !1), (this.touchTimeout = null), (this._config = this._getConfig(
            t
          )), (this._element = O(e)[0]), (this._indicatorsElement = O(
            this._element
          ).find(ne)[0]), this._addEventListeners();
        }
        var e = o.prototype;
        return (e.next = function() {
          ...
          e || (this._isPaused = !0), O(this._element).find(te)[0] &&
            (
          ...
          O(this._element).off(P), O.removeData(
            this._element,
            L
          ...
          return (this._items = O.makeArray(
            O(e).parent().find(ee)
          ...
          if (
            ...
            if (O(this._element).hasClass(V)) {
              O(l).addClass(i), Bn.reflow(l), O(s).addClass(n), O(l).addClass(
                n
              );
              ...
              O(s)
                .one(Bn.TRANSITION_END, function() {
                  O(l)
                    ...
                    .addClass(
                      Q
                    ), O(s).removeClass(Q + " " + i + " " + n), (o._isSliding = !1), setTimeout(function() {
                    return O(o._element).trigger(f);
                  }, 0);
                })
                .emulateTransitionEnd(d);
            } else
              O(s).removeClass(Q), O(l).addClass(Q), (this._isSliding = !1), O(
                this._element
              ).trigger(f);
            c && this.cycle();
          }
          ...
          return this.each(function() {
            ...
            if (
              (
                e || ((e = new o(this, t)), O(this).data(L, e)),
                "number" == typeof i
              )
            )
              e.to(i);
          ...
          if (t) {
            ...
            if (n && O(n).hasClass($)) {
              ...
              r && (i.interval = !1), o._jQueryInterface.call(O(n), i), r &&
                O(n).data(L).to(r), e.preventDefault();
            }
          }
        }), s(o, null, [
          {
        ...
        return (e.toggle = function() {
          ...
          if (
            ...
            if ((se(this._element).trigger(i), !i.isDefaultPrevented())) {
              ...
              se(this._element)
                .removeClass(ge)
                .addClass(me), (this._element.style[r] = 0) <
              ...
              se(this._element)
                .one(Bn.TRANSITION_END, function() {
                  se(n._element)
                    ...
                    .addClass(
                      pe
                    ), (n._element.style[r] = ""), n.setTransitioning(!1), se(n._element).trigger(he.SHOWN);
                })
          ...
          return ((e = u({}, fe, e)).toggle = Boolean(
            e.toggle
          )), Bn.typeCheckConfig(ae, e, de), e;
    ...
    Vn = (
      ...
      (Ge = (function() {
        ...
        return (e.toggle = function() {
              ...
              if ((Te(e).trigger(i), !i.isDefaultPrevented())) {
                if (!this._inNavbar) {
                  ...
                  "parent" === this._config.reference
                    ? (r = e)
                    : Bn.isElement(this._config.reference) &&
                      (
                        (r = this._config.reference),
                        void 0 !== this._config.reference.jquery &&
                          (r = this._config.reference[0])
                      ), "scrollParent" !== this._config.boundary &&
                    Te(e).addClass(Re), (this._popper = new c(
                    r,
                    this._menu,
                ...
                "ontouchstart" in document.documentElement &&
                  ...
                  "aria-expanded",
                  !0
                ), Te(this._menu).toggleClass(Oe), Te(e)
                  .toggleClass(Oe)
          ...
          Te.removeData(this._element, Ce), Te(this._element).off(
            De
          ...
          return (e = u(
            ...
            e
          )), Bn.typeCheckConfig(xe, e, this.constructor.DefaultType), e;
          ...
          var e = Te(this._element).parent(),
            t = $e;
          return e.hasClass(je)
            ? ((t = Ue), Te(this._menu).hasClass(He) && (t = Ke))
            : e.hasClass(Le)
              ? (t = Ve)
              : e.hasClass(Pe)
                ? (t = Ye)
                : Te(this._menu).hasClass(He) && (t = Qe), t;
            ...
            for (var t = Te.makeArray(Te(qe)), n = 0; n < t.length; n++) {
              ...
              if (r) {
                ...
                if (
                  ...
                  Te(i).trigger(a), a.isDefaultPrevented() ||
                    (
                      "ontouchstart" in document.documentElement &&
                        Te(document.body)
                          .children()
      ...
      (vt = (function() {
        function r(e, t) {
          (this._config = this._getConfig(
            t
          )), (this._element = e), (this._dialog = Je(e).find(
            ft
        ...
        return (e.toggle = function(e) {
          ...
          if (!this._isTransitioning && !this._isShown) {
            ...
            Je(this._element).trigger(n), this._isShown ||
          ...
          Je.removeData(this._element, et), Je(
            window,
            document,
            this._element,
            this._backdrop
          ...
          (this._element.parentNode &&
            ...
            "aria-hidden"
          ), (this._element.scrollTop = 0), n && Bn.reflow(this._element), Je(
            this._element
          ).addClass(ct), this._config.focus && this._enforceFocus();
          var i = Je.Event(ot.SHOWN, { relatedTarget: e }),
            r = function() {
              t._config.focus &&
                t._element.focus(), (t._isTransitioning = !1), Je(
                t._element
              ).trigger(i);
            };
          if (n) {
          ...
          Je(document).off(ot.FOCUSIN).on(ot.FOCUSIN, function(e) {
            document !== e.target &&
              t._element !== e.target &&
              0 === Je(t._element).has(e.target).length &&
              t._element.focus();
          });
        }), (e._setEscapeEvent = function() {
          var t = this;
          this._isShown && this._config.keyboard
            ? Je(this._element).on(ot.KEYDOWN_DISMISS, function(e) {
          ...
          (this._element.style.display = "none"), this._element.setAttribute(
            ...
            Je(document.body).removeClass(
              lt
            ), e._resetAdjustments(), e._resetScrollbar(), Je(e._element).trigger(ot.HIDDEN);
          });
          ...
          Je(pt).each(function(e, t) {
            ...
            void 0 !== n &&
              Je(t).css("padding-right", n).removeData("padding-right");
          ...
          return this.each(function() {
            ...
            if (
              (
                e || ((e = new r(this, t)), Je(this).data(et, e)),
                "string" == typeof n
              )
            ) {
              if (void 0 === e[n])
    ...
    zn = (
      ...
      (Wt = (function() {
        ...
        return (e.enable = function() {
          ...
          clearTimeout(this._timeout), yt.removeData(
            this.element,
            this.constructor.DATA_KEY
          ), yt(this.element).off(this.constructor.EVENT_KEY), yt(this.element)
            .closest(".modal")
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            i.setAttribute("id", r), this.element.setAttribute(
              "aria-describedby",
              r
            ), this.setContent(), this.config.animation && yt(i).addClass(It);
            var o =
            ...
            yt(i).data(this.constructor.DATA_KEY, this), yt.contains(
              this.element.ownerDocument.documentElement,
              this.tip
            ) || yt(i).appendTo(a), yt(this.element).trigger(
            ...
            })), yt(i).addClass(Ot), "ontouchstart" in
              document.documentElement &&
              yt(document.body).children().on("mouseover", null, yt.noop);
            var l = function() {
              t.config.animation && t._fixTransition();
              var e = t._hoverState;
              (t._hoverState = null), yt(t.element).trigger(
            ...
            r = function() {
              t._hoverState !== At &&
                ...
                n.parentNode.removeChild(
                  n
                ), t._cleanTipClass(), t.element.removeAttribute(
                "aria-describedby"
              ), yt(t.element).trigger(t.constructor.Event.HIDDEN), null !==
                t._popper && t._popper.destroy(), e && e();
            };
          if ((yt(this.element).trigger(i), !i.isDefaultPrevented())) {
            if (
              (
                yt(n).removeClass(Ot),
                "ontouchstart" in document.documentElement &&
                  yt(document.body).children().off("mouseover", null, yt.noop),
          ...
          this.setElementContent(e.find(jt), this.getTitle()), e.removeClass(
            It + " " + Ot
          );
          ...
          (t = t || yt(e.currentTarget).data(n)) ||
            ...
            ), e && (t._activeTrigger["focusin" === e.type ? Ht : Pt] = !0), yt(
            t.getTipElement()
          ).hasClass(Ot) || t._hoverState === At
            ? (t._hoverState = At)
            : (
          ...
          return "number" ==
            ...
            typeof e.content &&
            (e.content = e.content.toString()), Bn.typeCheckConfig(
            _t,
            e,
    ...
    Xn = (
      ...
      (Yt = u({}, zn.DefaultType, { content: "(string|element|function)" })),
      (zt = "fade"),
      (Gt = ".popover-header"),
      (Jt = ".popover-body"),
      (Zt = {
      ...
      (en = (function(e) {
        ...
        (n = e), ((t = i).prototype = Object.create(
          n.prototype
        ...
        return (r.isWithContent = function() {
          ...
          "function" == typeof t &&
            (t = t.call(this.element)), this.setElementContent(
            e.find(Jt),
            t
          ), e.removeClass(zt + " " + Xt);
          ...
          return this.each(function() {
            ...
            if (
              ...
              (
                e || ((e = new i(this, t)), Mt(this).data(Bt, e)),
                "string" == typeof n
              )
            ) {
              if (void 0 === e[n])
      ...
      (Tn = (function() {
        function n(e, t) {
          ...
          (this._element = e), (this._scrollElement =
            ...
            this._config.target +
            " " +
            _n), (this._offsets = []), (this._targets = []), (this._activeTarget = null), (this._scrollHeight = 0), tn(
            this._scrollElement
          ).on(un.SCROLL, function(e) {
            return n._process(e);
        ...
        return (e.refresh = function() {
          ...
          (this._offsets = []), (this._targets = []), (this._scrollHeight = this._getScrollHeight()), tn
          ...
          tn.removeData(this._element, rn), tn(this._scrollElement).off(
            on
          ...
          if (
            "string" !=
            typeof (e = u({}, an, "object" == typeof e && e ? e : {})).target
          ) {
            var t = tn(e.target).attr("id");
            t || ((t = Bn.getUID(nn)), tn(e.target).attr("id", t)), (e.target =
              "#" + t);
          }
      ...
      (Fn = (function() {
        ...
        return (e.show = function() {
          ...
          if (
            ...
            var s = xn.Event(An.HIDE, { relatedTarget: this._element }),
            ...
            if (
              ...
              var l = function() {
                var e = xn.Event(An.HIDDEN, { relatedTarget: n._element }),
                  t = xn.Event(An.SHOWN, { relatedTarget: i });
          ...
          if (t) {
            ...
            i && xn(i).removeClass(kn), "tab" === t.getAttribute("role") &&
          ...
          if (
            ...
            r && xn(r).find(Wn).addClass(kn), e.setAttribute(
              "aria-expanded",
              !0
            );
          }
          ...
          return this.each(function() {
            var e = xn(this),
              t = e.data(Cn);
            if (
              (t || ((t = new i(this)), e.data(Cn, t)), "string" == typeof n)
            ) {
              if (void 0 === t[n])
                throw new TypeError('No method named "' + n + '"');
              t[n]();
  ...
  !(function(e) {
    ...
    t
  ), (e.Util = Bn), (e.Alert = Un), (e.Button = Kn), (e.Carousel = $n), (e.Collapse = Qn), (e.Dropdown = Vn), (e.Modal = Yn), (e.Popover = Xn), (e.Scrollspy = Gn), (e.Tab = Jn), (e.Tooltip = zn), Object.defineProperty(e, "__esModule", { value: !0 });
});
