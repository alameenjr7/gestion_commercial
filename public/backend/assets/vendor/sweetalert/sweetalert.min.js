  ...
  return (function(t) {
        ...
        u = function(t) {
          ...
          switch (t.length) {
            case 1:
              ...
              break;
            case 2:
              (n[e.CANCEL_KEY] = c(e.CANCEL_KEY, t[0])), (n[e.CONFIRM_KEY] = c(
                e.CONFIRM_KEY,
                t[1]
              ));
              break;
    ...
    function(t, e, n) {
      ...
      e.initModalContent = function(t) {
        var e = o.getNode(a);
        p(e, t), c.default(t.icon), l.initTitle(t.title), l.initText(
          t.text
        ), f.default(t.content), u.default(t.buttons, t.dangerMode);
      };
      var m = function() {
        var t = o.getNode(s),
    ...
    function(t, e, n) {
      ...
      function c(t) {
        ...
        return (t.attrs.type = "text/css"), (t.attrs.rel = "stylesheet"), l(
          e,
          t.attrs
        ), i(t, e), e;
      }
      ...
      function u(t, e) {
        ...
        if (e.singleton) {
          var l = h++;
          (n = g || (g = s(e))), (o = f.bind(null, n, l, !1)), (r = f.bind(
            null,
            n,
            l,
            !0
    ...
    function(t, e, n) {
      var o = n(17);
      "undefined" == typeof window || window.Promise || (window.Promise = o), n(
        21
    ...
    function(t, e, n) {
      ...
      (e.setTimeout = function() {
        ...
        19
      ), (e.setImmediate = setImmediate), (e.clearImmediate = clearImmediate);
    },
    function(t, e, n) {
      (function(t, e) {
        !(function(t, n) {
    ...
    function(t, e, n) {
      ...
      (s.close = r.onAction), (s.getState = r.getState), (s.setActionValue =
        i.setActionValue), (s.stopLoading = r.stopLoading), (s.setDefaults =
        a.setDefaults), (e.default = s);
    },
    function(t, e, n) {
      "use strict";
      Object.defineProperty(e, "__esModule", { value: !0 });
      ...
      (e.init = function(t) {
        o.getNode(i) ||
          (
            ...
            s.default(),
            a.default()
          ), a.initModalContent(t), c.default(t);
      }), (e.default = e.init);
    },
    function(t, e, n) {
      "use strict";
      ...
      (e.modalMarkup =
        '\n  <div class="' +
        r +
        '" role="dialog" aria-modal="true"></div>'), (e.default =
        e.modalMarkup);
    },
    function(t, e, n) {
      "use strict";
    ...
    function(t, e, n) {
      ...
      var o = n(5),
        ...
        _ = function(t) {
          var e = i.getNode(u);
          e.removeEventListener("click", x), t &&
        ...
        O = function(t) {
          t.closeOnEsc
            ...
            : document.removeEventListener("keyup", p), t.dangerMode
            ? v()
    ...
    function(t, e, n) {
      ...
      e.getOpts = function() {
        ...
        (n.buttons = r.getButtonListOpts(
          o
        )), delete n.button, (n.content = i.getContentOpts(n.content));
    ...
    function(t, e, n) {
      ...
      Object.defineProperty(e, "__esModule", {
        ...
        (c += a
          ? " More details: " + l + a
          : " More details: " + l + "/guides/#upgrading-from-1x"), console.warn(
          c
        );
      }), (e.DEPRECATED_OPTS = {
