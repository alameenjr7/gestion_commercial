  ...
  function s(s) {
    ...
    return t('[data-notify="container"]').each(function(i, n) {
      var a = t(n),
        ...
        l =
          o === t("<div>" + s.settings.content.title + "</div>").html().trim(),
        d =
          r ===
  ...
  (String.format = function() {
    ...
    buildNotify: function() {
      ...
      (this.$ele = t(
        ...
        this.$ele.find('[data-notify="dismiss"]').css("display", "none"), ((this
        .settings.delay <= 0 &&
    ...
    close: function() {
      ...
      this.$ele
        ...
        i ||
          (s.$ele.remove(), s.settings.onClosed && s.settings.onClosed(s.$ele));
      }, 600);
    },
