...
!(function(a, b, c, d) {
  var e = function(b, c) {
    (this.elem = b), (this.$elem = a(
      b
    )), (this.options = c), (this.localize_i18n = {
      multiField: {
        messages: {
  ...
  (e.prototype = {
    ...
    init: function() {
      ...
      return (this.config = a.extend(
        ...
        (b.localize_i18n = this.config.locale), this.getSectionsCount() < 2 &&
        a(this.config.btnRemove, this.$elem).hide(), this.$elem.on(
        "click",
        this.config.btnAdd,
        function(a) {
    ...
    cloneSection: function() {
      ...
      }), a("input[type=radio]", b).attr("checked", !1), a(
        "img.reset-image-src",
        b
      ).each(function() {
        a(this).attr("src", "");
    ...
    removeSection: function(b) {
      if (confirm(this.localize_i18n.multiField.messages.removeConfirmation)) {
        ...
        c <= 2 &&
          a(
            this.config.btnRemove,
            this.$elem
          ).hide(), b.slideUp("fast", function() {
          a(this).detach();
        });
      }
    },
